...
| 4 | Άσκηση γραμμής εντολών (pandoc blog) |[Συζήτηση](https://github.com/courses-ionio/hci/discussions/1980) | |
...
Οσον αφορά τα θέματα με τα οποία ασχολήθηκα, επέλεξα τις φορητές κονσόλες βιντεοπαιχνιδιών και τις κάρτες ήχου.
Αναλυτικότερα:
...
# 4ο Παραδοτέο: Εκτέλεση ασκήσεων "Warm up" σε i3 γραφικό περιβάλλον


Η άσκηση που επέλεξα από τη λίστα "Warm up" ήταν η πρώτη και σαν κύριο στόχο είχε την αλλαγή του command prompt, την εμφάνιση των dot αρχείων, την ανάδειξη του shell configuration file και τέλος την ανάδειξη του software
και hardware του συστήματος. Η επιλογή της άσκησης έγινε με βάση το μάθημα των Λειτουργικών Συστημάτων που έχουμε παράλληλα στο οποίο εκτελούμε παρόμοιες εργασίες μέσω CL. Η διαφορά όμως του μαθήματος αυτού είναι ότι οι εντολές που εκτελούμε γίνονται μέσω virtual machine των Ubuntu Linux, κάτι το οποίο δεν μας προσφαίρει την ίδια εμπειρία προσωπικά με το γραφικό περιβάλλον i3. 

- Σύγκριση γραφικού περιβάλλοντος i3 με Linux Desktop Environments (LDE):
Σαν χρήστης που ξεκίνησε με την εγκατάσταση LDE, παρατήρησα τα εξής όσον αφορά τα διαφορετικά περιβάλλοντα:
      ...
      - Μετά από έρευνα παρατήρησα ότι υπάρχει μεγάλη ευέληξία στη προσαρμογή του i3, ακόμη περισσότερη από τα LDE τα οποία είχα αναφαίρει σε προηγούμενο παροδοτέο.
