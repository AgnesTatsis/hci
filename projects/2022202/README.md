...
- Ορθός σχεδιασμός και σύνταξη ενός εγγράφου σαν αυτό της αναφοράς του μαθήματος για μελλοντική χρήση σε εργασίες ή ανάρτηση προσωπικών ενδιαφερόντων (πληροφορική, ζωγραφική, digital desigh)
