...
Συγκεκριμένα, στις φορητές κονσόλες, σε αντίθεση με ένα Playstation για παράδειγμα, τα χαρακτηριστηκά της σταθερής συσκευής, των γραφικών και του τηλεχειριστηρίου εννόνονται σε μία συσκευή μικρότερη σε μέγεθος και εύκολη στη μεταφορά. Σαν άλλες συσκευές, δεν χρειάζονται συνεχή τροφοδώτηση ρεύματος και σε ορισμένα μοντέλα υπάρχει η δυνατότητα λήψης παιχνιδιών και μέσω διαδικτύου. Οι λειτουργείες αυτές καθιστούν τις κονσόλες πρακτικές συσκευές ψυχαγωγίας καθώς δεν υπάρχει περιορισμός όσον αφορά την τοποθεσία.
Η πρώτη φορητή κονσόλα που βγήκε στην αγορά ήταν αυτή του Milton Bradley Microvision και κυκλοφώρησε το 1979. Για τη συγκεκριμένη συσκευή, κάθε παιχνίδι είχε τον δικό του επεξεργαστή συμπεριλαμβανόμενο μέσα στον αφαιρούμενο σκληρό δίσκο (removable cartridge).
