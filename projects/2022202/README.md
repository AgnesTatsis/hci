...
- Δημιούργησα πρώτα ένα αρχείο .txt με τα βασικά χαρακτηριστικά όπως title, author, date και τρία headers για να ξεχωρίσω το θέμα που θα αναλύσω. Για αρχή, σαν θέμα επέλεξα το Window Manager καθώς είναι για την ώρα αυτό που έχει κινήσει περισσότερο το εωδιαφέρον στο μάθημα.
