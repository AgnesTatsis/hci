...
Η πρώτη φορητή κονσόλα ήταν αυτή του Milton Bradley Microvision και κυκλοφώρησε το 1979. Κάθε παιχνίδι είχε τον δικό του επεξεργαστή συμπεριλαμβανόμενο μέσα στον αφαιρούμενο σκληρό δίσκο (removable cartridge).
